...
const loginUserCtrl = expressAsyncHandler(async (req, res) => {
  ...
  //check if blocked
  if(userFound?.isBlocked) throw new Error("Access Denied");
...
const generateVerificationTokenCtrl = expressAsyncHandler(async (req, res) => {
  ...
  try {
    ...
    let response = {
      body: {
        name: "My first Node js email sending",
        intro: "Hey check me out for this email",
    ...
    let message = {
      from: "nahidhossain124@gmail.com",
      to: user?.email,
      subject: "Place Order",
      html: mail,
    };
